...
CREATE TABLE SystemControl.[Table] (
  TableId int IDENTITY NOT NULL, 
  Name    varchar(255) NOT NULL UNIQUE, 
  PRIMARY KEY (TableId));
CREATE TABLE SystemControl.[Column] (
...
CREATE TABLE Customers.Contacts (
  ...
  CustomerId int NOT NULL);
GO
-- TODO: ADD 'ON DELETE CASCADE ON UPDATE CASCADE'
...
ALTER TABLE Stock.ProductModel ADD CONSTRAINT FKProductMod979572 FOREIGN KEY (SizeId) REFERENCES [Size] (SizeId);
ALTER TABLE Stock.ProductModel ADD CONSTRAINT FKProductMod345309 FOREIGN KEY (BrandId) REFERENCES Brand (BrandId);
...
ALTER TABLE SystemControl.[Column] ADD CONSTRAINT FKColumn913976 FOREIGN KEY (TableId) REFERENCES SystemControl.[Table] (TableId);
ALTER TABLE SystemControl.ColumnInfo ADD CONSTRAINT FKColumnInfo892014 FOREIGN KEY (ColumnId) REFERENCES SystemControl.[Column] (Id);
ALTER TABLE SystemControl.ColumnInfo ADD CONSTRAINT FKColumnInfo882752 FOREIGN KEY (ReferencesColumn) REFERENCES SystemControl.[Column] (Id);
ALTER TABLE SystemControl.Estimation ADD CONSTRAINT FKEstimation556284 FOREIGN KEY (TableId) REFERENCES SystemControl.[Table] (TableId);
