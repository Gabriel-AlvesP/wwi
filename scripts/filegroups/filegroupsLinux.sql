...
on primary (
    ...
    filename = '/var/opt/mssql/data/wwiglobal_primary.mdf',
    size = 10MB,
    maxsize = 20MB,
    filegrowth = 10MB
),
...
filegroup WWIGlobal_fg1 (
    name = 'wwiglobal_fg1',
    filename = '/var/opt/mssql/data/wwiglobal_fg1.ndf',
    size = 10MB,
    maxsize = 30MB,
    filegrowth = 10MB
),
...
filegroup WWIGlobal_fg2 (
    name = 'wwiglobal_fg2',
    filename = '/var/opt/mssql/data/wwiglobal_fg2.ndf',
    size = 10MB,
    maxsize = 50MB,
    filegrowth = 20MB
),
...
filegroup WWIGlobal_fg3 (
    name = 'wwiglobal_fg3_1',
    filename = '/var/opt/mssql/data/wwiglobal_fg3_dat1.ndf',
    size = 20MB,
    maxsize = 60MB,
    filegrowth = 20MB
),
(
    name = 'wwiglobal_fg3_2',
    filename = '/var/opt/mssql/data/wwiglobal_fg3_dat2.ndf',
    size = 30MB,
    maxsize = 80MB,
    filegrowth = 25MB
)
