...
ALTER TABLE SystemControl.[Column] DROP CONSTRAINT FKColumn913976;
ALTER TABLE SystemControl.ColumnInfo DROP CONSTRAINT FKColumnInfo892014;
ALTER TABLE SystemControl.ColumnInfo DROP CONSTRAINT FKColumnInfo882752;
ALTER TABLE SystemControl.Estimation DROP CONSTRAINT FKEstimation556284;
ALTER TABLE Customers.Contacts DROP CONSTRAINT FKContacts573379;
GO
DROP TABLE IF EXISTS Customers.Customer;
DROP TABLE IF EXISTS Authentication.Token;
...
DROP TABLE IF EXISTS SystemControl.[Table];
DROP TABLE IF EXISTS SystemControl.[Column];
